...
import { useETHBalances, useAggregateKwikBalance } from '../../state/wallet/hooks'
      ...
      <HeaderControls>
        <HeaderElement>
          ...
          {availableClaim && !showClaimPopup && (
            <KWIKWrapper onClick={toggleClaimModal}>
              <KWIKAmount active={!!account && !availableClaim} style={{ pointerEvents: 'auto' }}>
                <TYPE.white padding="0 2px">
                  {claimTxn && !claimTxn?.receipt ? <Dots>Claiming KWIK</Dots> : 'Claim KWIK'}
                </TYPE.white>
              </KWIKAmount>
              <CardNoise />
            </KWIKWrapper>
