import { JSBI, TokenAmount } from '@kwikswap/sdk'
...
import { CloseIcon, CustomLightSpinner, ExternalLink, TYPE, KwikTokenAnimated } from '../../theme'
      ...
      {!attempting && !claimConfirmed && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim KWIK</TYPE.white>
            ...
            <CardSection gap="sm">
              {userClaimData?.flags?.isSOCKS && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{SOCKS_AMOUNT} KWIK</TYPE.subHeader>
                </RowBetween>
              )}
              ...
              {userClaimData?.flags?.isUser && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{USER_AMOUNT} KWIK</TYPE.subHeader>
                </RowBetween>
              )}
            </CardSection>
          </ModalUpper>
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <ConfirmedIcon>
            {!claimConfirmed ? (
              ...
              <KwikTokenAnimated width="72px" src={tokenLogo} />
            )}
          </ConfirmedIcon>
