...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB')).toBe('0x0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB')
      expect(isAddress('0x0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB')).toBe('0x0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB')).toBe('0x0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB')
    })
    it('fails if too long', () => {
      expect(isAddress('0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB0')).toBe(false)
    })
  })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB')).toBe('0x0A3B...03cB')
    })

    it('truncates middle characters even without prefix', () => {
      expect(shortenAddress('0A3B7f58c52b32B5D3326D5E7C78614AbE8103cB')).toBe('0x0A3B...03cB')
    })
