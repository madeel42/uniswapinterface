...
import { JSBI, Token, TokenAmount, WETH, Fraction, Percent, CurrencyAmount } from '@kwikswap/sdk'
...
import { useVExchangeContract } from '../../hooks/useContract'
...
import { VLiquidityInfo } from './MigrateVExchange'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${chainId && token.equals(WETH[chainId]) ? 'WETH' : token.symbol}/ETH V liquidity`
        })
  ...
  return (
    <AutoColumn gap="20px">
      <TYPE.body my={9} style={{ fontWeight: 400 }}>
        This tool will remove your V liquidity and send the underlying assets to your wallet.
      </TYPE.body>
...
export default function RemoveVExchange({
  match: {
    params: { address }
  }
  ...
  const exchangeContract = useVExchangeContract(validatedAddress ? validatedAddress : undefined, true)
  ...
  return (
    <BodyWrapper style={{ padding: 24 }} id="remove-v-exchange">
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          <BackArrow to="/migrate/v" />
          <TYPE.mediumHeader>Remove V Liquidity</TYPE.mediumHeader>
          <div>
            <QuestionHelper text="Remove your Kwikswap V liquidity tokens." />
          </div>
        </AutoRow>
